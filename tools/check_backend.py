...
require("request_key" in backend and "AI_KEY or" in backend, "backend does not accept the app API key as fallback")
require("为什么答案成立" in backend and "不要只写" in backend and "mode" in backend, "AI prompt does not demand useful explanations and metadata filtering")
