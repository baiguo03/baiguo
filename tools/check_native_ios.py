...
require("UIFont.systemFont(ofSize: 27" in view, "native title size does not match V10 preview")
require("tabStack.heightAnchor.constraint(equalToConstant: 86)" in view, "native tab bar height does not match V10 preview")
...
require("stack.layer.cornerRadius = 22" in view, "native cards/lists do not match V10 preview")
