...
for old in ["刷题工具", "QuizNativeV5", "QuizNativeV4", "QuizNativeV3", "QuizNativeV2"]:
    require(old not in view + parser + project + plist + yaml, f"old marker remains: {old}")

require("PRODUCT_NAME = QuizNativeV6;" in project, "missing QuizNativeV6 product")
...
require("QuizNativeV6.ipa" in yaml, "Codemagic artifact is not V6")
require("&#x4e91;&#x9898;V6" in plist, "display name is not 云题V6")
